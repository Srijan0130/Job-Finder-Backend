...
import StatComponent from '../../component/Stat/StatComponent';
        ...
        <>
            <Box>
                ...
                >
                    ...
                    <StatComponent
                        value="45621"
                        icon={<SupervisorAccountIcon sx={{ color: "#ffffff", fontSize: 30 }} />}
                    ...
                    <StatComponent
                        value="6548"
                        icon={<CategoryIcon sx={{ color: "#ffffff", fontSize: 30 }} />}
